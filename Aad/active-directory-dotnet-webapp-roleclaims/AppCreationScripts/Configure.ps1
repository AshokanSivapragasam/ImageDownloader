...
#> 
   ...
   Write-Host "Creating the AAD application (EiRoleClaimsDotNet002)"
   $serviceAadApplication = New-AzureADApplication -DisplayName "EiRoleClaimsDotNet002" `
                                                   -HomePage "https://localhost:44322/" `
                                                   -LogoutUrl "https://localhost:44322/Account/EndSession" `
                                                   -ReplyUrls "https://localhost:44322/" `
                                                   -IdentifierUris "https://$tenantName/EiRoleClaimsDotNet002" `
                                                   -PublicClient $False
   ...
   Write-Host "Done creating the service application (EiRoleClaimsDotNet002)"
   ...
   Add-Content -Value "<tr><td>service</td><td>$currentAppId</td><td><a href='$servicePortalUrl'>EiRoleClaimsDotNet002</a></td></tr>" -Path createdApps.html
   ...
   Write-Host "  - Run the ..\CreateUsersAndRoles.ps1 command to automatically create a number of users, app roles and assign users to these roles or refer to the 'Define your application roles' section in README on how to configure your newly created app further for this sample."
