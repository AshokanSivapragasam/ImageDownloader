...
#> 
    ...
    # Add the roles
    Write-Host "Adding app roles to to the app 'EiRoleClaimsDotNet002' in tenant '$tenantName'"

    $app = Get-AzureADApplication -Filter "identifierUris/any(uri:uri eq 'https://$tenantName/EiRoleClaimsDotNet002')"  
    ...
    if ($app)
    {
        ...
        Write-Host "Successfully added app roles to the app 'EiRoleClaimsDotNet002'."
        ...
        Write-Host "Failed to add app roles to the app 'EiRoleClaimsDotNet002'."
    }
