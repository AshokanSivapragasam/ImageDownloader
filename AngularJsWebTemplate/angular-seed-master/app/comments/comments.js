    ...
    .controller('CommentsController', ['$scope', '$http', '$sce', '$log', 'commonService', function($scope, $http, $sce, $log, commonService) {
        ...
        $scope.viewComments = function() {
            ...
            if($scope.isShowComments) {
                $http.get('http://hydpcm347350d/TamilYogiWebApi/resources/videocomments/' + commonService.currentVideoMirrorId)
        ...
        $scope.publishComment = function () {
            ...
            $http({
                url: 'http://hydpcm347350d/TamilYogiWebApi/resources/videocomments',
